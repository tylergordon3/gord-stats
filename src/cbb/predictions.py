...
def predict_womens(date):
    ensemble = joblib.load(paths.ML_DIR / "2026" / "womens_2-20-2026.pkl")
...
def predict_tor(date):
    ensemble = joblib.load(paths.ML_DIR / "2026" / "men_tor_2-23-2026.pkl")
...
def predict_ken(date):
    ensemble = joblib.load(paths.ML_DIR / "2026" / "men_ken_2-24-2026.pkl")
